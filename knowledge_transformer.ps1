...
function Move-KMFile($source_url, $target_lib_name, $file_name, $conn_source, $conn_target){
...
foreach($original_case_study_doc in $original_case_study_docs){
    ...
    if($null -eq $converted_case_study){
        ...
        Move-KMFile -source_url $converted_case_study_url -target_lib_name 'Case Studies' -file_name $converted_case_study_file_name -conn_source $conn_km -conn_target $conn_k
        ...
        Move-KMFile -source_url $original_case_study_url -target_lib_name 'Sources' -file_name $original_case_study_file_name -credential $user_credential
